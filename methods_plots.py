...
def plot_model_decomposition_overlay(datasets_dict, style_map):
    ...
    # save figure
    fig.savefig("figures/decomposition_full_year.png", dpi=300, bbox_inches="tight")
...
def plot_monthly_profile(datasets, style_map):
    ...
    plt.savefig("/content/figures/monthly_profile.png")
